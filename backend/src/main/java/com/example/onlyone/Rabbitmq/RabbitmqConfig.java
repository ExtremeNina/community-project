...
public class RabbitmqConfig {
    ...
    public Queue articlePushQueue() {
        ...
        return new Queue("articlePushQueue", true,false,false,args);
    }
    ...
    public DirectExchange moderationExchange() {
        return new DirectExchange("moderation.exchange", true, false);
    }
    ...
    @Bean
    public Binding moderationRequestBinding() {
        return BindingBuilder.bind(moderationRequestQueue())
                .to(moderationExchange()).with("moderation.request");
    }

    @Bean
    public Queue moderationResultQueue() {
        return new Queue("moderation.result.queue", true);
    }
